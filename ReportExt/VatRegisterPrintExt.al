report 59000 "VAT Register - Print MSC"
{
    DefaultLayout = RDLC;
    ...
    requestpage
    {
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(VATRegisterList; RegisterList)
                    {
                        ApplicationArea = Basic, Suite;
                        ...
                        begin
                            If Page.RunModal(Page::"VAT Registers", "VAT Register") = Action::LookupOK then begin
                                if "VAT Register".FindSet() then
                                    repeat
                                        RegisterList := RegisterList + '|' + "VAT Register".Code;
                                    until "VAT Register".Next() = 0;
                                exit(true);
                            end;
                        end;
